 ...
 * (e.g. Annabelle) and a savings balance
...
public class Beneficiary {
	 ...
	 * privileged objects responsible for
	 * reconstituting an existing Account object from some external form such as a
	 * collection of database records.
	 * Marked package-private to indicate this constructor should never be called by
	 * general application code.
	 * 
	 * @param name                 the name of the beneficiary
	 * @param allocationPercentage the beneficiary's allocation percentage within
	 *                             its account
	 * @param savings              the total amount saved to-date for this
	 *                             beneficiary
	 */
	...
	public String toString() {
		return "name = '" + name + "', allocationPercentage = " + allocationPercentage + ", savings = "
				+ savings + ")";
	}
}
