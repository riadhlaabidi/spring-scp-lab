...
public class RewardNetworkPropagationTests {
	...
	/**
	 * Inappropriate test, just for demo purposes, rewarding an account shouldn't
	 * happen in a new transaction, it should join or create the only transaction
	 * whithin it will be executed.
	 */
	@Test
	@Disabled
