 ...
 * an account in the reward network. In
...
public class Dining {
	...
	/**
	 * Creates a new dining, reflecting an amount that was charged to a card by a
	 * merchant on the date specified.
	 * 
	 * @param amount           the total amount of the dining bill
	 * @param creditCardNumber the number of the credit card used to pay for the
	 *                         dining bill
	 * @param merchantNumber   the merchant number of the restaurant where the
	 *                         dining occurred
	...
	/**
	 * Creates a new dining, reflecting an amount that was charged to a credit card
	 * by a merchant on today's date. A
	...
	/**
	 * Creates a new dining, reflecting an amount that was charged to a credit card
	 * by a merchant on the date specified.
	...
	/**
	 * Returns the number of the credit card used to pay for this dining. For this
	 * dining to be eligible for reward,
	 * this credit card number should be associated with a valid account in the
	 * reward network.
	 */
	...
	/**
	 * Returns the merchant number of the restaurant where this dining occurred. For
	 * this dining to be eligible for
	 * reward, this merchant number should be associated with a valid restaurant in
	 * the reward network.
	 */
