...
/**
 * A summary of a monetary contribution made to an account that was distributed
...
public class AccountContribution {
	 ...
	 * @param distributions how the contribution was distributed among the account's
	 *                      beneficiaries
	 */
	...
	/**
	 * Returns how this contribution was distributed among the account's
	 * beneficiaries.
	 * 
	...
	/**
	 * Returns how this contribution was distributed to a single account
	 * beneficiary.
	 * 
	 * @param beneficiary the name of the beneficiary e.g "Annabelle"
	 * @return a summary of how the contribution amount was distributed to the
	 *         beneficiary
	 */
	...
	/**
	 * A single distribution made to a beneficiary as part of an account
	 * contribution, summarizing the distribution
	...
	public static class Distribution {
		 ...
		 * 
		 * @param beneficiary  the name of the account beneficiary that received a
		 *                     distribution
		 * @param amount       the distribution amount
		 * @param percentage   this distribution's percentage of the total account
		 *                     contribution
		 * @param totalSavings the beneficiary's total savings amount after the
		...
		/**
		 * Returns the percentage of this distribution relative to others in the
		 * contribution.
		 */
