...
public class AccountClientTests {
    ...
    public void listAccounts_using_valid_user_should_succeed() {
        String url = "/accounts";
        // we have to use Account[] instead of List<Account>, or
        ...
        assertThat(accounts.length >= 21)
                .withFailMessage("Expected 21 accounts, but found " + accounts.length)
                .isTrue();
    ...
    public void getAccount_using_valid_user_should_succeed() {
        ...
        assertThat(account.getBeneficiary("Annabelle").getAllocationPercentage())
                .isEqualTo(Percentage.valueOf("50%"));
    }
    ...
    public void addAndDeleteBeneficiary_using_superadmin_should_succeed() {
        // perform both add and delete to avoid issues with side
        // effects
        String addUrl = "/accounts/{accountId}/beneficiaries";
        URI newBeneficiaryLocation = restTemplate
        ...
        ResponseEntity<Beneficiary> response = restTemplate
                .withBasicAuth("superadmin", "superadmin")
